      ...
      <header class="policy-header">
        <div class="container">
          <div class="header-content">
            <h1 class="page-title">Gestion de la Politique de confidentialité</h1>
            <BaseButton
              variant="primary"
      ...
      <main class="policy-main">
        <div class="container">
          ...
          <div v-if="!activeVersion && versions.length > 0" class="notification warning">
            <strong>Attention :</strong> Aucune version de Politique de confidentialité n'est actuellement active. Les utilisateurs ne pourront pas consulter la Politique de confidentialité sur le formulaire d'inscription.
          </div>
        ...
        >
          <div class="modal-content">
            ...
            <div class="modal-body">
              <p>Êtes-vous sûr de vouloir supprimer cette version de Politique de confidentialité ?</p>
...
import PolicyEditor from '@/components/admin/policy/PolicyEditor.vue';
...
const {
  ...
  updateVersion,
  setActiveVersion,
  deleteVersion: deletePolicyVersion
} = usePolicy();
...
const deleteVersion = () => {
  try {
    deletePolicyVersion(versionToDelete.value);
