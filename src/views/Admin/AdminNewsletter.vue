      ...
      <header class="newsletter-header">
        <div class="container">
          <div class="header-content">
            <h1 class="page-title">Gestion des newsletters</h1>
            <BaseButton
              variant="primary"
      ...
      <main class="newsletter-main">
        <div class="container">
          ...
          <div v-if="!activeVersion && versions.length > 0" class="notification warning">
            <strong>Attention :</strong> Aucune version de newsletter n'est actuellement active. Les utilisateurs ne pourront pas consulter les newsletters sur le formulaire d'inscription.
          </div>
        ...
        >
          <div class="modal-content">
            ...
            <div class="modal-body">
              <p>Êtes-vous sûr de vouloir supprimer cette version de newsletter ?</p>
...
import { useNewsletter } from '@/composables/manager/useNewsletter';

import AdminSidebar from '@/components/admin/sidebar/AdminSidebar.vue';
import NewsletterList from '@/components/admin/newsletter/NewsletterList.vue';
import NewsletterEditor from '@/components/admin/newsletter/NewsletterEditor.vue';
...
const {
  ...
  updateVersion,
  setActiveVersion,
  deleteVersion: deleteNewsletterVersion
} = useNewsletter();
...
const deleteVersion = () => {
  try {
    deleteNewsletterVersion(versionToDelete.value);
