      ...
      <header class="cgu-header">
        <div class="container">
          <div class="header-content">
            <h1 class="page-title">Gestion des CGU</h1>
            <BaseButton
              variant="primary"
      ...
      <main class="cgu-main">
        <div class="container">
          ...
          <div v-if="!activeVersion && versions.length > 0" class="notification warning">
            <strong>Attention :</strong> Aucune version de CGU n'est actuellement active. Les utilisateurs ne pourront pas consulter les CGU sur le formulaire d'inscription.
          </div>
        ...
        >
          <div class="modal-content">
            ...
            <div class="modal-body">
              <p>Êtes-vous sûr de vouloir supprimer cette version de CGU ?</p>
...
import CGUEditor from '@/components/admin/cgu/CGUEditor.vue';
...
const {
  ...
  updateVersion,
  setActiveVersion,
  deleteVersion: deleteCGUVersion
} = useCGU();
...
const deleteVersion = () => {
  try {
    deleteCGUVersion(versionToDelete.value);
