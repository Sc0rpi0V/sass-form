    ...
    <div class="modal-overlay" @click.self="close">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <!-- Si aucune Policy active -->
          <div v-if="!activeVersion" class="no-policy">
            <p>Aucune version de la politique de confidentialité n'est actuellement disponible.</p>
          </div>

          <!-- Si Policy active disponible -->
...
const { activeVersion } = usePolicy();

const policyTitle = computed(() => {
  return activeVersion.value?.title || 'Politique de confidentialité';
});
