<template>
  <div class="cgv-editor">
    <div class="editor-header">
      <h2>
        {{ mode === 'create' ? 'Nouvelle version CGV' : mode === 'edit' ? 'Éditer la version' : 'Détails de la version' }}
      </h2>
    </div>
    ...
    <form v-else @submit.prevent="handleSave" class="editor-form">
      <div class="form-group">
        <BaseInput
          ...
          :disabled="mode === 'view'"
        />
        <p class="field-hint">Par défaut : "Conditions Générales de Ventes"</p>
      </div>
      ...
      <div class="form-group">
        ...
        <BaseTextarea
          ...
          :rows="25"
          placeholder="Saisissez le contenu des CGV..."
...
const handleSave = () => {
  ...
  emit('save', {
    title: formData.value.title.trim() || 'Conditions Générales d\'Utilisation',
